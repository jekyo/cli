...
jekyo/0.4.1 linux-x64 node-v14.17.5
$ jekyo --help [COMMAND]
USAGE
  $ jekyo COMMAND
...
...
_See code: [src/commands/app/create.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/app/create.js)_
...
_See code: [src/commands/app/delete.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/app/delete.js)_
...
_See code: [src/commands/app/list.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/app/list.js)_
...
_See code: [src/commands/app/logs.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/app/logs.js)_
...
_See code: [src/commands/app/status.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/app/status.js)_
...
_See code: [src/commands/deploy.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/deploy.js)_
...
_See code: [src/commands/link.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/link.js)_
...
_See code: [src/commands/login.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/login.js)_
...
_See code: [src/commands/logs.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/logs.js)_
...
_See code: [src/commands/status.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/status.js)_
...
_See code: [src/commands/user/confirm.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/user/confirm.js)_
...
_See code: [src/commands/user/recover.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/user/recover.js)_
...
_See code: [src/commands/user/signin.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/user/signin.js)_
...
_See code: [src/commands/user/signup.js](https://github.com/jekyo/cli/blob/v0.4.1/src/commands/user/signup.js)_
<!-- commandsstop -->
